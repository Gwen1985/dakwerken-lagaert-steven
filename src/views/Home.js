...
import zibo from '../assets/zibo-zhou-a1UebqCK03c-unsplash.jpg';
        ...
        <div className="container-fluid">
            <div className="home">
                    ...
                    <div className="col-sm-12 col-md-6 p-4 d-flex justify-content-center">
                        <Link to="/hellende-daken" className="text-decoration-none">
                            <div className="dienstCard text-center">
                                ...
                                <p className="dienstText p-4">Dakgebintes timmeren, VELUX-ramen en dakpannen plaatsen,
                                    dakgoten
                                    installeren,…
                    ...
                    <div className="col-sm-12 col-md-6 p-4 d-flex justify-content-center">
                        <Link to="/zink-werken" className="text-decoration-none">
                            <div className="dienstCard text-center">
                                ...
                                <p className="dienstText p-4">Steven plaatst dak- en hanggoten en bekleedt ze vakkundig
                                    in
                                    diverse materialen
                    ...
                    <div className="col-sm-12 col-md-6 p-4 d-flex justify-content-center">
                        <Link to="/gevel-bekleding" className="text-decoration-none">
                            <div className="dienstCard text-center">
                                ...
                                <p className="dienstText p-4">Voor stijlvolle en professionele gevelbekleding die tegen
                                    een
                                    stootje kan, moet u
                    ...
                    <div className="col-sm-12 col-md-6 col-lg-6 p-4 d-flex justify-content-center">
                        <Link to="/realisaties" className="text-decoration-none">
                            <div className="dienstCard text-center">
                                ...
                                <p className="dienstText p-4">Bekijk Stevens vorige projecten en doe inspiratie op voor
                                    uw eigen
                                    werken. Zijn
                ...
                <div className="row mt-4 ">
                    <img src={zibo} alt="zibo" width="100%" className="zibo"/>
                    ...
                    <div className="centered_2">
                        <div className="col-sm-12 p-4 text-center">
                            ...
                            <div className="container-fluid p-4">
                                <p className="p-4 text-white">Dakwerken Lagaert uit Evergem is uw dakwerker voor hellende & platte
                                    daken en
                                    helpt u met
                            ...
                            <ul className="d-flex justify-content-center">
                                <li className="list-unstyled">
                                    <a href="https://www.facebook.com/stevenlagaert" target="_blank" rel="noreferrer"><i
                                        className="fb fab fa-facebook p-3"/></a>
                                </li>

                                <li className="list-unstyled">
                                    <a href="https://www.instagram.com/dak_en_renovatiewerken_lagaert" target="_blank"
                                       rel="noreferrer"><i
                                        className="insta fab fa-instagram p-3"/></a>
                                </li>
                            </ul>
                            </div>

                            <span>onze gegevens</span>
