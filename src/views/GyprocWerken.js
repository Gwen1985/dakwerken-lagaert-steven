                ...
                <div className="row gyprocHeaderImg">
                    ...
                    <div className="col-12 text-center">
                        <div className="container p-3">
                            ...
                            <p className="headerTitle text-white p-3">Van kleine kamers & zolders tot volledige
                                woningen.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="row my-5">
                    <div className="col-sm-12 col-xl-6">
                        <div className="container p-2">
                            ...
                            <h2 className="contentTitle_2 py-2">Uw ruimtes optimaal benut</h2>

                            <p className="contentText mt-2">Wil u graag een extra slaapkamer creëren op zolder of
                                valse wanden en plafonds laten plaatsen? Dakwerken Lagaert Steven helpt u graag met
                                Gyprocwerken.</p>

                            <p className="contentText ">In eender welke ruimte kan Steven Gyprocplaten
                                plaatsen, naargelang uw behoeften. De platen kunt u achteraf eenvoudig overschilderen of
                                behangen.</p>

                            <p className="contentText">Van kleine kamers en zolders herinrichten tot
                                volledige woningen onder handen nemen, Steven doet het allemaal met plezier.</p>

                            <p className="contentText">Steven zit eerst met u samen om uw plannen te
                                bespreken
                                en vertaalt uw wensen nadien zorgvuldig naar de realiteit.</p>

                            <p className="contentText">Ga voor de inrichting van uw dromen met Dakwerken
                                Lagaert Steven!</p>
                        </div>
                    </div>
